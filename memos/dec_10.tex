...
One challenging thing is whether we are looking under the lamp post with an easy of AI-induced unemployment. But the Felten et al measure is \textbf{not} designed to capture automation risk, as they say, ``we remain agnostic to whether occupational exposure to generative AI is likely to result in automation vs. augmentation of occupations''. \\
...
It seems like if anything was happening, it was not happening until this year, so I run a DiD just between 2024-5. I just cut the data into high and low AI exposure majors, and see if there is a differential change in enrollment, and enrollment growth rates.
\subsection{DiD w.r.t. AI Exposure}
\input{did_motivating_regression.tex}
